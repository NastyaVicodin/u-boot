 ...
 * @vtermno: This number identifies the number that we used to register
 *           with hvc; this is the number passed on by the hvc callbacks
 *           to us to differentiate between the other console ports handled
 *           by this driver
 * @hvc:	 The hvc device associated with this console port
 */
